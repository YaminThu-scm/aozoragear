 ...
 */
// function executeFunctionByName(distance, onmouseover) {
// 	var holiday = $('.fc-h-event').hasClass( "holiday-event" );
// 			if(holiday) {
//         console.log('KTH',test);
// 				test = ' holiday-tooltip vvv';
//         return test;
// 			} else {
// 				test = ' aaa';
//         return test
// 			}
// };
// console.log('VVV',distance())
// functionTwo();
// function functionTwo() {
//   $('.fc-h-event').mouseover(function(){
//     alert("vvvv");
//   });
// }
...
function pageReady(){
  ...
  $(document).on('mouseover','.fc-h-event', function (event) {
    var test = '';  
    var holiday = $(this).hasClass( "holiday-event" );
			if(holiday) {
        $('.tooltip').addClass('vvv')
        $('.tooltip').removeClass('boo')


			} else {
        $('.tooltip').addClass('boo')
        $('.tooltip').removeClass('vvv')
...
(function(a, b) {
  ...
  var c = function(a, b) {
    ...
    f = {
      ...
      placement: 'top',
      title: '',
      template: '<div class="tooltip '+  pageReady() +'" role="tooltip"><div class="tooltip-arrow"></div><div class="tooltip-inner"></div></div>',
      trigger: 'hover focus',
      offset: 0,
